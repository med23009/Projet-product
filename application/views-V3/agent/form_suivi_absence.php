...
<div class="container" >
   ...
   <div class="center_content">
           ...
           <?php    echo form_open('agent/suivi_absence');
           $time = strtotime("2011-07-01 00:00:00");


           ?>
       <table width="100%"><tr> <td>Date debut:</td><td><input type="date" name="dateD" id="dateD"/></td><td>Date fin:</td><td><input type="date"  name="dateF" id="dateF"/></td><td>Statut:</td><td>
                       </td><td align="right"> <td class="submit">

                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="field desc">
                                                            <input value="  " class="form-control" id="title" name="title" placeholder="Description" type="text" value="">
                                                        </div>
                                                    </div>
                                                    <script>
                                                        $(document).ready(function () {
                                                    ...
                                                    <div class="row">
                                                        <div class='col-sm-6'>
                                                            <input value="<?php echo $finCours; ?>" placeholder="Date fin" type='text' class="form-control" id='dfin' />
                                                        </div>
                                                        <script type="text/javascript">
                                                            $(function () {
                                                                $('#dfin').datetimepicker({
                                             ...
                                             <!-- <input class="form-control"  placeholder="Date fin" type="text" id="dfin" />-->
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                            <div class='col-sm-6'>
                                                                <input type='text' value="<?php echo $finCours;?>" class="form-control" id='endTime' />
                                                            </div>
                                                            <script type="text/javascript">
                                                                $(function () {
...
<?php ?>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <label>Remplacer</label><input name="chk1" value="1" type="checkbox" id="chk1"  />
                                    ...
                                    <div id="calendarModal" class="modal fade">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <h4 class="modal-title">Modification , Supression OU Duplication</h4>
                                                </div>
  ...
  <!--<input  class="form-control" name="endTimeM" type="text" id="endTimeM"/>-->
                                                  ...
                                                  <!--   <input type="text" id="eventIDGR"/>-->
                                                  
                                                      <select class="form-control" id="infomodule_element_dropdownD" onchange="selectState(this.options[this.selectedIndex].value)">
                                                                                <option value="-1">choisissez l'element</option>
                                                                            </select>
                                                                           <select class="form-control" id="eventIDG">
                                                   </select>

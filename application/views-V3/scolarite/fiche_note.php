<?php include(APPPATH.'views/include/header.php');
   ...
   <div class="container">
    <div class="col-xs-12 hl-left">
         ...
         <?php echo heading('Fiche de notes','2');       
           echo form_open('scolarite/fiche_note_element');
         ?>
...
<!--        
        ...
        <div>
            <table style="width: 600px;" class="table">
                ...
                <tr>
                    ...
                    <td>
                    <?php
                        echo ' <select name="grade" id="" class="form-control my-2"> ';
                ...
                <!-- -->
                 <tr>
                    ...
                    <select name="evaluation" id="" class="form-control"> 
                     ...
                     <tr>
                    <td style="font-size: large;">Trié par :</td>
                    <td>
                    
                        <select name="tri" id="" class="form-control"> 
                        <option value="a">Anonymat</option>
        ...
        <br>
        <div class="submit">
                        <?php $pw = array('type' => 'submit', 'name' => 'submit', 'id'=>'submit5', 'value'=>'Valider','class'=>'btn btn-success p-3'); 
                            echo form_input($pw);?>
                    </div>

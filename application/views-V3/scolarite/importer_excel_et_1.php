 ...
 <script>
  $(document).ready(function(){
	  ...
	  $("#formfile").submit(function(){
		...
		$.ajax({ 
       url : '<?php echo base_url(); ?>index.php/scolarite/controle_ficher_etudiant',
...
$('<p id=btn1 ><img class="NFButtonleft" src="http://127.0.0.1/iup/images/0.png"><button  id=btn1 class=NFButton  >importer</button><img src="http://127.0.0.1/iup/images/0.png" class="NFButtonRight"></p>').appendTo("#btn");}
	  var donnees=JSON.stringify(obj.donnees)
	   $("#btn1").click(function(){
		  ...
		  $.ajax({
       url : '<?php echo base_url(); ?>index.php/scolarite/import_to_table_et',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
...
$("<div class=check><input name=check type=checkbox class=form-check-input ><font size=2pt color=black>voulez vous modifier les lignes existant<br></div><br>").appendTo("#is");
 ...
 $("#btn1").remove();
   ...
   check='non';
       ...
       url : '<?php echo base_url(); ?>index.php/scolarite/mettre_a_jour_lignes_Existe_et',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
      ...
      alert("erreur verifier le ficher"); 
		 ...
		 table1=$(this).find("input[name=table1]").val();
$.ajax({ 
       url : '<?php echo base_url(); ?>index.php/scolarite/controle_ficher_dossieretudiant',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
       data : new FormData(this),// On fait passer nos variables, exactement comme en GET
       dataType : 'html',
contentType: false,
		...
		if(obj.infocorrect){
		 ...
		 // le button importer
	   if(obj.donnees!=null){
$('<p id="btn1"></p>').appendTo("#btn");}
	  var donnees=JSON.stringify(obj.donnees)
	   $("#btn1").click(function(){
		   //l'envoi des donnees a importer
		  $.ajax({
       url : '<?php echo base_url(); ?>index.php/scolarite/import_to_table_etd',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
       data : 'donnees='+donnees+'&table1='+table1,// On fait passer nos variables, exactement comme en GET
       dataType : 'html',
	   success : function(data){
...
$("<div class=check><input name=check type=checkbox class=form-check-input ><font size=2pt color=black>voulez vous modifier les lignes existant<br></div><br>").appendTo("#is");
 ...
 $("#btn1").remove();
   ...
   check='non';
       ...
       url : '<?php echo base_url(); ?>index.php/scolarite/mettre_a_jour_lignes_Existe_etd',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
       data :'existeData='+existeData+'&newData='+newData+'&donnees='+donnees+'&check='+check +'&table1='+table1,// On fait passer nos variables, exactement comme en GET, au script more_com.php
       dataType : 'html',
	   success : function(data){
		   // message importation avec succes apres la modification ou non
			//console.log(data); 
      ...
      alert("erreur verifier le ficher"); 
		 ...
		 table2=$(this).find("input[name=table2]").val();
$.ajax({ 
       url : '<?php echo base_url(); ?>index.php/scolarite/controle_ficher_aut',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
       data : new FormData(this),// On fait passer nos variables, exactement comme en GET
       dataType : 'html',
contentType: false,
...
$('<p id=btn1 ></p>').appendTo("#btn");}
	  var donnees=JSON.stringify(obj.donnees)
	   $("#btn1").click(function(){
		   //l'envoi des donnees a importer
		  $.ajax({
       url : '<?php echo base_url(); ?>index.php/scolarite/import_to_table_aut',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
       data : 'donnees='+donnees+'&table2='+table2,// On fait passer nos variables, exactement comme en GET
       dataType : 'html',
	   success : function(data){
...
$("<div class=check><input name=check type=checkbox class=form-check-input ><font size=2pt color=black>voulez vous modifier les lignes existant<br></div><br>").appendTo("#is");
 ...
 $("#btn1").remove();
   ...
   check='non';
       ...
       url : '<?php echo base_url(); ?>index.php/scolarite/mettre_a_jour_lignes_Existe_aut',
       type : 'POST', // Le type de la requête HTTP, ici devenu POST
       data :'existeData='+existeData+'&newData='+newData+'&donnees='+donnees+'&check='+check +'&table2='+table2,// On fait passer nos variables, exactement comme en GET, au script more_com.php
       dataType : 'html',
	   success : function(data){
		   // message importation avec succes apres la modification ou non
			//console.log(data); 
...
<form  method=post enctype='multipart/form-data'  id=formfile   >
   ...
   <input type=hidden name=table1  value=<?php echo $table1;?> >
    <input type=hidden name=table2  value=<?php echo $table2;?> >

                    ...
                    $annee_univ=(substr($groupe,strpos ($groupe,'-')+1,strpos ($groupe,'-',2))-1).'-'.(substr($groupe,strpos ($groupe,'-')+1,strpos ($groupe,'-',2)));
                         ...
                         <td>
                             <table >
                              ...
                              <tr><td><span style="font-size: 8.0pt;font-family: Arial,serif;">&nbsp;Moyenne de connaissance &nbsp;</style></td>
                                 </tr></table>
...
newwin.document.write('<TITLE>FicheNote_Moyenne_connaissance-'+'<?php echo $sigle;?>'+'-G:'+'<?=$idgoupe?>'+'-Annee:<?=$annee_univ?></TITLE>\n')

...
echo'<TR>
	...
	<TD class="tr12 td42"><P class="p0 ft1">&nbsp;</P></TD>
        <TD class="tr12 td4"><P class="p29 ft16" >'.(!empty($module) && !empty($module['ects'])?$module['ects']:0).' ['.(!empty($module) &&!empty($module['coefficient'])?$module['coefficient']:0).']'.'</P></TD>
...
<P class="p33 ft12">Date et Signature
</P>

<?php include(APPPATH.'views/include/header.php');
    ...
    <div class="col-xs-12 hl-left">
         ...
         <?php echo heading('Génération liste des rattrapeurs','2');       
           echo form_open('scolarite/afficher_list_ratrappeur');
         ?>
...
<!--                 <tr>
        ...
        <br>
        <div class="submit">
                        <?php $pw = array('type' => 'submit', 'name' => 'submit', 'id'=>'submit5', 'value'=>'Générer','class'=>'btn btn-success'); 
                            echo form_input($pw);?>
                    </div>

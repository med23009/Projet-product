 ...
 //26-10-2021 addad by fatimetou
          function get_etudiants_matricules($programme,$annee,$semestre){
           if($semestre%2==0) {
            ...
            $requette="SELECT DISTINCT matriculeEtudiant FROM `dossieretudiant` where idProgramme='$programme' and matriculeEtudiant in (select matriculeEtudiant from notespartielles where annee='$annee' and semestre='$semestre' )";

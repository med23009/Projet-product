...
<script>
   ...
   var table=  $('#example').DataTable( {
        "ajax": "<?php echo base_url(); ?>index.php/directeur_etudes/info_plannig_exam",
        "columns": [
            { "data": "id" },
             { "data": "planning" }
    ...
    var crenau=    $('#crenau').val();
     ...
     $('#add').click( function () {
      ...
      $('#fiche').click( function () {
         ...
         window.location.href="<?php echo base_url(); ?>index.php/directeur_etudes/planning_examens?planing="+data.id+"&idProgramme="+idProgramme+"";
     });

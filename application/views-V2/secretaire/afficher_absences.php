...
<div class="center_content">  
    ...
    <div class="right_content">  
        ...
        <?php
        // RM modif 23 février 2013 echo heading('Consulter les absences du groupe <b>'.$idGroupe[0].' .</b>', '3');
		echo heading('Consulter les absences du groupe <b>'.$this->secretaire_modele->corrigerNumGroupe($idGroupe[0]).' .</b>', '3');
	/*

 ...
 <div class="container">
    <div class="col-xs-12 hl-left"> 
       ...
       <?php                if(is_array($programme['idProgramme']))
        ...
        <div class="form-group">
<!--                <label class="control-label col-sm-2" for="email">Sans anonymat :</label> -->                     <div class="col-sm-10">
              
                      <?php
                    $input = array('type' => 'hidden', 'name' => 'anonymat', 'value' => '0', 'class' => 'form-control','checked'=>'true');

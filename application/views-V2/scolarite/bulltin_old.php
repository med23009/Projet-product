                 ...
                 <td><img src="../../images/logo_iup_abra.png" height="70" width="90" ></td>
                  ...
                  <td> 
                      <table  border="0" style="line-height: 10px">
                          ...
                          <tr>
                              <td style="font-size: 50%;border-top: 1px solid black">Cité Cadres - Sebkha, Téléphone : +222 49 00 05 47 Mobile : +222 49 00 05 47, Email : scolarite@esp.com</td>
                          </tr>
                          <tr>
...
<TR>
	...
	<TD class="tr0 td2"><P class="p0 ft7">DOMAINE</P></TD>
        ...
        if($info['idProgramme']=="MAEF"){
          ...
          $option="";
        if($info['idProgramme']=="MAEF"){
            $option="Mathématiques Appliquées A l'Economie et A  la Fina...";
          }else if($info['idProgramme']=="MAN"){
            $option="Management";
          }else if($info['idProgramme']=="LGTR"){
...
echo'<TR>
	...
	<TD class="tr12 td4"><P class=" ft16" style="text-align: center;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;">'.$module['ects'].' ['.$module['coefficient'].']'.'</P></TD>
	...
	<TD class="tr10 td72"><P class="p28 ft26">'.$module['nm'].'</P></TD>';
                     if($module['decision']=='VE' || $module['decision']=='VC' || $module['decision']=='V'){
                                      $module['decision']='ValidÃ©';
                                  }elseif ($module['decision']=='NV') {
             $module['decision']='Non validÃ©';
        }
...
<DIV id="id_6">
<P class="p33 ft7">Â© TOUS DROITS RESERVES ABRA SCO 2016</P>
</DIV>
</DIV>
</BODY>
</HTML>

    ...
    <div class="container">
        <div class="col-xs-12 hl-left">
         ...
         <?php echo heading($titre,'3');
            ...
            echo form_open('scolarite/liste_etudiant_niveau_credit',$attributes);
            echo '<table class="form" id="tableProf">';
          ?>
        
            <tr>
                comment <th style="text-align:left;">Année</th>
            ...
            <tr>
                ...
                <td>
                    <select     name="idProgramme"  id="idProgramme" >
                         <!-- comment <option value="tous">Tous</option>-->
                        <?php
                ...
                <td>
                    <select name="niveau">
                        ...
                        <option value="1">3<sup>ème</sup> année</option>
                        <option value="2">4<sup>ème</sup> année</option>
                        <option value="3">5<sup>ème</sup> année</option>
                    </select>

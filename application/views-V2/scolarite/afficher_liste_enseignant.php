<?php include(APPPATH.'views/include/header.php');
 ...
 <button  onClick="imprimer('printable');" style="float:right; height: 30px; background-color:#cceac4; width: 160px; margin-right:185px; margin-top:50px;"><b> Imprimer la liste </b></button>
     <?php
        ...
        echo form_open('scolarite/generer_excel_liste_enseingant', $attributes);
        ?>
<div class="container">
        ...
        if ($numeroSemestre == 3) {
            ...
            return 'Printemps';
                    ...
                    for($i=0;$i<count($infoEnseignant['matriculeEmploye']);$i++)
                    {
                        ...
                        echo "<tr>";
                        echo "<td>".anchor('scolarite/saisir_horaire/'.$infoEnseignant['matriculeEmploye'][$i], $infoEnseignant['matriculeEmploye'][$i])."</td>

...
.fc-event-start {
    ...
    <body  >
        ...
        <!--   <script src="https://github.com/MrRio/jsPDF/blob/master/plugins/autoprint.js"></script>-->
            ...
            <!--add by MedBAkar 14-04-2020 pour ajuster le design -->
            <style>
                body{
...
//$('#calendar').fullCalendar( 'removeEvents' );
                                            ...
                                            $('body').on('click', 'button.fc-prev-button', function () {
                                                ...
                                                if (str == "1") {
                                                    ...
                                                    document.getElementById("cours").innerHTML = "<h1>Emploi du temps du  Semestre " + semestre1 + "  Filiere " + idProgramme1 + "</h1>";
                                                    selectModule(type = 1);
                                                } else if (str == "2") {
                                                    //var node=  document.getElementById("ens");
                                                    // var textContent = node.textContent;

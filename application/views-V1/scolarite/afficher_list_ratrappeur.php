<?php include(APPPATH.'views/include/header.php');
    ...
    <div class="col-xs-12 hl-left">
         ...
         <?php echo heading("liste des élèves qui sont invités à participer au rattrapage",'2');       
         ?>
       ...
       -->
        ...
        <div id="imprimer">
            <table style="width: 100%;height:150px">
                ...
                <tr><td><b style="font-size:18px">liste des élèves qui sont invités à participer au rattrapage</b></td> <td><?php// echo $param_gen[0]['email']?></td></tr>
...
if($nbr_element_valide[$matriculeEtud]!=$maquette_inscrit[$matriculeEtud]){//on affiche pas les etudiants qui on validé leurs maquette by MedBakar 02-08-2020
echo"<tr>";   
...
//             echo"<p style='text-align:center;background-color: #E36C09;font-size: 16px'><span style='color: #D9E8FB;font-size: 16px;'>vide...</span></p>";
   ?>
             ...
             <br>
             <span style='text-align:center;background-color: #979797;font-size: 16px;'>Explication des annotations: V: validé, RAT-OP: rattrapage optionnel,RAT-OB: rattrapage obligatoire<br></span>
        </div>

...
<TR>
    <TD class="tr9 td10"><P class="p0 ft12" >Pr&eacute;nom du P&eacute;re</P></TD>
	<TD class="tr9 td11"><P class="p4 ft12">:</P></TD>
...
<TR>    
 ...
 if(file_exists("C:\wamp\www\laureat\photos/". $info['matriculeEtudiant'].'.GIF'))
        ...
        else echo "../../photos/". $info['matriculeEtudiant'].'.bmp'; 
...
<TD colspan=2 class="tr0 td34"><P class="p19 ft4">MOYENNE DE COMP&Eacute;TENCES</P></TD>
...
<TD  colspan="2" rowspan=3 class="tr16 td50" ><P class="p29 ft15">Note</P></TD>
	<!--<TD rowspan=3 class="tr8 td47"><P class="p11 ft15" style="text-align: center">Atome</P></TD>-->
	<!--  -->
...
<!--	<TD rowspan=2 class="tr16 td50" ><P class="p29 ft15" >Note</P></TD>-->
	<TD rowspan=2 class="tr16 td51"><P class="p9 ft23" style="text-align: center">Validés</P></TD>
...
<TR>
	...
	<TD class="tr6 td50" colspan="2"><P class="p0 ft24">&nbsp;</P></TD>
...
<!--<TD class="tr6 td55"><P class="p11 ft25" style="text-align: center">&nbsp;</P></TD>-->
	...
	<TD class="tr6 td42"><P class="p11 ft25" style="text-align: center">Rattr.</P></TD>
...
<TR>
	...
	<TD class="tr1 td63" colspan="2"><P class="p0 ft2">&nbsp;</P></TD>
...
echo'<TR>
	...
	<TD class="tr12 td50" colspan=2><P class="p0 ft1">&nbsp;</P></TD>';
...
<TR>
	...
	<TD class="tr17 td50" colspan=2 ><P class=" ft16" style="text-align:center;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;">'.number_format($element['ncc'][$k],2).'</P></TD>';
...
<TR>
	...
	<TD class="tr20 td63" colspan="2"><P class="p0 ft28">&nbsp;</P></TD>
...
<TR>
	   <td rowspan="7" style="" >
            <?php if($numSem%2==0 and $annee>2017 and $numSem>=$max_semestre ){?>
...
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L1(CR&Eacute;DIT<sub>s1</sub>+CR&Eacute;DIT<sub>s2</sub>)>=<?php $reg=30;  if( $passage['regle']==2){$reg=39;}echo $reg;?></span></p>
</td>
</tr>
<?php }elseif($niveau=="2"){ ?>
<tr style="height: 13.5pt;">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L1(CR&Eacute;DIT<sub>s1</sub>+CR&Eacute;DIT<sub>s2</sub>)=60</span></p>
</td>
</tr>
<tr style="height: 13.5pt;">
    <td style="width: 5.0pt; border: solid #E36C09 1.0pt; border-top: none; border-bottom: none; border-right: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L2(CR&Eacute;DIT<sub>s3</sub>+CR&Eacute;DIT<sub>s4</sub>)>=<?php if ($passage['regle']==1){ echo "30";}else{echo "39";}?></span></p>
</td>
</tr>
<?php }elseif($niveau=="3"){ ?>
<tr style="height: 13.5pt;">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L2(CR&Eacute;DIT<sub>s3</sub>+CR&Eacute;DIT<sub>s4</sub>)=60</span></p>
</td>
</tr>
<tr style="height: 13.5pt;">
    <td style="width: 5.0pt; border: solid #E36C09 1.0pt; border-top: none; border-bottom: none; border-right: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
    <p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L2(CR&Eacute;DIT<sub>s5</sub>+CR&Eacute;DIT<sub>s6</sub>)>=60</span></p>
</td>
</tr>
<?php }?>
...
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
    <p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total CR&Eacute;DIT L<?php echo $niveau; ?></span></p>
</td>
...
<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total CR&Eacute;DIT L<?php  echo $niveau-1; ?></span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL1'] ?></span></p>
</td>
...
<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total CR&Eacute;DIT L<?php  $info['niveau']=($numSem+1)/2;echo ''. substr($info['niveau'], 0,1)  ; ?></span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
...
<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total CR&Eacute;DIT L1</span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL1'] ?></span></p>
</td>
...
<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total CR&Eacute;DIT L2</span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL2'] ?></span></p>
</td>
...
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total CR&Eacute;DIT L3</span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
...
<td colspan="2" style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
    <p style="margin-top: 5PX;"><span style="font-size: 7.0pt; font-family: 'Times New Roman','serif';"><B><?php  if($passage['niveau']>$niveau){ if($numSem==6){echo "VALIDATION";}ELSE{echo"PASSAGE en L".$passage['niveau'];}}else{echo"REDOUBLEMENT";}?></b></span></p>
</td>
...
<TR>
	<TD class="tr19 td117"><P class="p0 ft1">&nbsp;</P></TD>
        <TD colspan=2 rowspan=2 class="tr24 td118"><P class="p11 ft32"><NOBR><?php if(!empty($semestre['ects']) &&$semestre['ects']==30){echo 'VALIDATION';}else{ echo 'AJOURNEMENT'; } ?> </P></TD>
      <!--  <TD colspan=2 rowspan=2 class="tr24 td118"><P class="p11 ft32"><NOBR><?php if(!empty($semestre['ects']) &&$semestre['ects']==30){echo 'VALIDATION';}else{ echo 'NON VALIDATION'; } ?> </P></TD>-->
...
<P class="p33 ft12">CHEF SERVICE SCOLARITE</P>
        ...
        <tr>
                <td height="">
                    <span style="font-size: 8.0pt;">   FAIT &Aacute; NOUAKCHOTT, LE <?php echo date('d/m/Y');?></span>
                </td>
            </tr></table>
</DIV>
</DIV>

               ...
               echo'<input name="matriculeEtudiant" type="hidden" value="'.$info['matriculeEtudiant'].'"/>';
                         for ($i = 0; $i < count($moduleR_impairelist); ++$i) { ?>
                              <tr>
                                 ...
                                 <?php echo'<td> <input readonly type="checkbox" name="sigleImpaire[]" value="'.$moduleR_impairelist[$i]->sigle.'"  readonly checked  ></td>';
                                  ?>
                           ...
                           for ($i = 0; $i < count($modules_a_etudies_impairelist); ++$i) { ?>
                              <tr>
                                <?php
                                  ...
                                  echo '<td id="contenu" > <input  type="checkbox" name="sigleImpaire[]" value="'.$modules_a_etudies_impairelist[$i]->sigle.'"   ></td>' ;
                               }else{
                                   
                                     echo '<td id="contenu"> <input readonly type="checkbox" name="sigleImpaire[]" value="'.$modules_a_etudies_impairelist[$i]->sigle.'"  readonly checked  ></td>' ;
                       ...
                       ?>   
                             ...
                             <?php for ($i = 0; $i < count($moduleR_pairelist); ++$i) { ?>
                              <tr>
                                  ...
                                  <?php  echo'<td> <input readonly value="'.$moduleR_pairelist[$i]->sigle.'" type="checkbox" name="siglePaire[]"   readonly checked  ></td>';
                                  ?>
                         ...
                         <?php } ?>
                             ...
                             echo'<tr>';
                                  ...
                                  echo '<td id="contenu" > <input type="checkbox" name="siglePaire[]" value="'.$modules_a_etudies_pairelist[$i]->sigle.'"  ></td>' ;
                               }else{
                                   
                                     echo '<td id="contenu"> <input readonly type="checkbox" name="siglePaire[]" value="'.$modules_a_etudies_pairelist[$i]->sigle.'"   readonly checked  ></td>' ;

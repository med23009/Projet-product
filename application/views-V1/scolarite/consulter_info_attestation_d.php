...
<p style="margin-bottom: .0001pt; text-indent: 10.0pt; line-height: normal;"><span style="font-size: 10.0pt; color: black;">Le Directeur des Affaires  Académiques de l'<?php echo $parametres['nom'] ?> <?php echo (empty($parametres['nom_ins_parent_fr']))? (' '):(" de l'".$parametres['nom_ins_parent_fr']); ?> atteste que l'&eacute;l&eacute;ve ingénieur(e) est  inscrit(e) &agrave; l'école pour l'ann&eacute;e Académique <?php echo ' '.$anneeuniv.'-'.($anneeuniv+1).' '; ?> sous les donn&eacute;es suivantes : </span></p>
</td>
</tr>
...
<p style="margin-bottom: .0001pt; text-indent: 10.05pt; line-height: normal;"><strong><span style="font-size: 10.0pt; color: black;">L’éléve ingénieur(e) bénéficie des droits que lui confère cette inscription .L’éléve ingénieur(e) est également soumis aux obligations que lui impose cette inscription.</span></strong></p>
</td>
</tr>
<tr style="height: 6.75pt;">
<td style="width: 23.35pt; padding: 0cm 3.5pt 0cm 3.5pt; height: 6.75pt;" width="31">&nbsp;</td>

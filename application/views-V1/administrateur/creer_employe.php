...
include('include/menu.php');?> 
 ...
 echo validation_errors('<div class="error_box">', '</div>');
	if(isset($errorMessage))
        ...
        echo form_open('administrateur/creer_employe');
        echo form_fieldset();
        ?>
         ...
         <table border="0">
            <tr>
                <td><?php echo form_label('Profil'.'<span style="color:red;font-weight:bold;font-size:14px;">*</span>', 'profils'); ?></td>
                ...
                <td><?php echo form_checkbox(array('name' => 'agent'), 'agent', False);?></td>
        ...
        <table class="form">
            <tr>
                ...
                <td><?php
                    $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'lastName');
            ...
            <tr>
                ...
                <td><?php
                    $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'firstName');
                    echo form_input($input,'','');?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><?php  $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'email');
                       echo form_input($input, '');?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><?php echo form_label('Dernier diplôme ', 'dernierDiplome'); ?></td>
                <td><?php  $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'dernierDiplome');
                       echo form_input($input, '');?>
                </td>
            </tr>
            <tr>
                <td><?php echo form_label('Pays du diplôme ', 'paysDiplome'); ?></td>
                 <td><?php 
                            ...
                            echo'</select>';
                             echo form_error('paysDiplome','<span class="error">','</span>');
                            ?>
                        </td>
            </tr>
            <tr>
                <td><?php echo form_label('Grade ', 'grade'); ?></td>
                <td><?php // $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'grade');
                       //echo form_input($input, '');
             ...
             <tr>
                <td><?php echo form_label('Télephone 1 ', 'telephone1'); ?></td>
                <td><?php  $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'telephone1');
                       echo form_input($input, '');?>
                </td>
            </tr>
            <tr>
                <td><?php echo form_label('Télephone 2 ', 'telephone2'); ?></td>
                <td><?php  $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'telephone2');
                       echo form_input($input, '');?>
                </td>
            </tr>
            <tr>
                <td><?php echo form_label('Cordonnées bancaires ', 'compteBancaire'); ?></td>
                <td><?php  $input = array('class' => 'form-control','type' => 'text', 'size' => '40', 'name' => 'compteBancaire');
                       echo form_input($input, '');?>
                </td>
            </tr>
        </table>

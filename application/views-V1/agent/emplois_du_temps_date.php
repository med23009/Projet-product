...
//}
                        ...
                        eventDrop: function (event, delta) {
                            $.ajax({
                                url: '<?php echo base_url(); ?>index.php/agent/emplois_du_temps',
                    ...
                    function doDelete() {
                        ...
                        $.ajax({
                            url: '<?php echo base_url(); ?>index.php/agent/emplois_du_temps',
                            data: 'action=delete&id=' + eventID + '&rd=' + rd + '&type=' + type + '&prof=' + prof + '&local=' + local + '&type1=' + typeS + '&eventIDG=' + eventIDG + '&title=' + title + '&start=' + start + '&end=' + end,
                            type: "POST",
                            success: function (json) {
                                if (json == 1)
                                                            ...
                                                            <div class="panel panel-primary">
                                                                ...
                                                                <div class="panel-body">		<select id="employe1" >
                                                                        ...
                                                                        for ($i = 0; $i < count($employe['matriculeEmploye']); $i++) {
                                                                            ...
                                                                            $employe['nom'][$i] . ' ' . $employe['prenom'][$i] . '</div></option>';
                                                                        }
                                                                        ?>
                                        ...
                                        <script>
                                            ...
                                            function showUser(str) {
                                                ...
                                                if (str == "1") {
                                                    ...
                                                    document.getElementById("cours").innerHTML = "<h2>Emploi du temps du  Semestre " + semestre1 + "  Filière " + idProgramme1 + " </h2>";
                                                    selectModule(type = 1);
                                                } else if (str == "2") {
...
<?php //  } ?>
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/emplois_du_temps_avec_date?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "";
                                                    $('#startTime1').val(events);
                                                   // $('#calendar').fullCalendar('destroy');
                                                   $('#calendar').fullCalendar('removeEvents');
                                                    $('#calendar').fullCalendar('addEventSource', "<?php echo base_url(); ?>index.php/agent/emplois_du_temps_avec_date?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "");
...
<?php //  } ?>
                                            ...
                                            function showChevauch() {
                                                ...
                                                var events = "<?php echo base_url(); ?>index.php/agent/chevauchement?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=" + id + "";
                                            ...
                                            function showCHSALLE(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/chevauchement?local2=" + str + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=" + id + "";
                                            ...
                                            function showEMP(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/chevauchement2?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + str + "&id=" + id + "";
                                            ...
                                            function showChevauchA() {
                                                ...
                                                var events = "<?php echo base_url(); ?>index.php/agent/chevauchement?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=0";
                                            ...
                                            function showCHSALLEA(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/chevauchement?local2=" + str + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=0";
                                            ...
                                            function showEMPA(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/chevauchement2?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + str + "&id=0";
                                                ...
                                                <div class="modal-body">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="field desc">
                                                            <input class="form-control" id="title" name="title" placeholder="Description" type="text" value="Cours">
                                                        </div>
                                                    </div>
                                                    <script>
                                                        $(document).ready(function () {

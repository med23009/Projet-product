...
<div class="center_content">
    ...
    echo form_open('secretaire/generer_rappor_note_module',$attributes);?>
            <thead>
                <?php
                
                if (is_array($resultas) && count($resultas) > 0) 
                {
                    echo "<tr><th>Matricule</th><th>Note</th><th>Cote</th><th>Lien</th></tr>";
                    ?>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($matricules as $matricule) 
                    {
                        ...
                        echo "<td>".$resultas[$counter]['lien']."</td></tr>";
                        $counter++;
                    }
                }

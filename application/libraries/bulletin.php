...
class Bulletin extends FPDF {
    ...
    {       
        ...
        // $this->Image($_SERVER["DOCUMENT_ROOT"].'Bulletins/Bulletin_Recto.png',0,0,21); //Modif 2.2.2 permet d'inclure l'image en fond de toutes les pages
		// voir bulletin_logo.php
		$this->SetFont('Arial','',10);
//commented by Hafedh 26/10/2013
...
$this->Cell(2.5,0.5,' ',0,0,'C');
    ...
    function InformationsPersonnelle($info_personnelles)
    {
        ...
        $this->Cell(0,0.5, $info_personnelles['prenom'].'  '.$info_personnelles['surnom'].'  '.$info_personnelles['nom'],0,1,'L');
    ...
    function AjouterLabelSuiteReleve()
    {
        // Police Arial gras 10
        $this->SetFont('Arial','B',10);
  //commented by Hafedh 25/11/2013      

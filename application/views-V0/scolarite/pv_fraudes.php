...
<script>
   ...
   var table=  $('#example').DataTable( {
        "ajax": "<?php echo base_url(); ?>index.php/scolarite/info_pv_fraudes",
        "columns": [
            { "data": "id" },
...
table.ajax.reload(null, false);
        ...
        $('#createEventModal1').modal('hide'); 
         if (window.XMLHttpRequest) {
                                                    ...
                                                    xmlhttp.onreadystatechange = function () {
                                                     ...
                                                     var matriculeetudiant= $('#etudiant_element_dropdown').val(); 
                                                     var sigle=    $('#tous_element_dropdown').val();
    ...
    statu="0"; //alert(statu);
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/scolarite/ajouter_pv_fraudes?matriculeetudiant=" + matriculeetudiant +"&sigle=" + sigle+"&semestre=" + semestre+"&annee=" + annee+"&note=" + note+"&session=" + session+"&statu=" + statu+ "";
    ...
    <div class="col-xs-12 hl-left">
      <button class="btn btn-default btn-sm" id="add"><span class="glyphicon glyphicon-plus-sign"></span>Ajouter</button><button class="btn btn-default btn-sm" id="delete"><span class="glyphicon glyphicon-trash"></span>Supprimer</button><button class="btn btn-default btn-sm" id="update"><span class="glyphicon glyphicon-edit"></span>Modifier</button>
       ...
       <div class="modal-dialog">
            ...
            <div class="col-lg-8 col-sm-8">
                <select class="form-control" id="tous_element_dropdown" name="sigle" onchange="selectEtudiant(this.options[this.selectedIndex].value)" >
    ...
    <script>
         function selectModule(type) {
                                                     ...
                                                     //   ElementsPlanning('infomodule_element', idProgramme, annee, semestre, type=1, matriculeEmploye);
                                                        ElementsPlanning('tous_element', idProgramme, annee, semestre, type=1, matriculeEmploye);
                                                      
                                                        } 
                                                        }
                                                           function selectEtudiant(element) {
                                                               var annee = $("#date").val();
                                                                var semestre = $("#semestre1").val();
                                                                var idProgramme = $("#idProgramme1").val();
                                                                var type=1;
                                                                if (element != "-1") {
                                                     //   ElementsPlanning('infomodule_element', idProgramme, annee, semestre, type=1, matriculeEmploye);
                                                        ElementsPlanning('etudiant_element', idProgramme, annee, semestre, type, element);
                                                      
                                                        } 
                                                        }


                                                        function ElementsPlanning(loadType, loadId, annee, semestre, type, element) {
                                                        var annee = $("#date").val();
                                                                var semestre = $("#semestre1").val();
                                                                var idProgramme = $("#idProgramme1").val();
                                                                var matriculeEmploye = $("#employe1").val();
                                                                var dataString = 'loadType=' + loadType + '&loadId=' + loadId + '&annee=' + annee + '&semestre=' + semestre + '&type=' + type + '&matriculeEmploye=' + element;

    ...
    <div class="container">
        <div class="col-xs-12 hl-left">
         ...
         <?php echo heading($titre,'3');
            ...
            echo form_open('scolarite/trouver_etudiant_pour_la_carte',$attributes);
          ...
          ?>
            ...
            <tr>
                ...
                <td>
                    <input class="form-control" type="number" maxlength="5" minlength="5" name="matricule">
                </td>
            ...
            <tr>
                 <td class="submit">
                 <?php $pw = array('type' => 'submit', 'name' => 'submit', 'id'=>'submit', 'value'=>'Afficher la carte');
                 echo form_input($pw);?>
                 </td>
            </tr>
         </table>

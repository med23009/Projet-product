...
<script>
   ...
   var table=  $('#example').DataTable( {
        "ajax": "<?php echo base_url(); ?>index.php/scolarite/info_etudiants",
        "columns": [
    ...
    $('#example tbody').on( 'click', 'tr', function () {
      ...
      alert(matricule)
      window.location.href='<?php echo base_url(); ?>index.php/scolarite/maj_note_etudiant?matricule='+matricule;
    } );
   ...
   // alert(statuM);
    if(statuM=="1"){
     ...
     $('#historique').click( function () {
         window.location.href='<?php echo base_url(); ?>index.php/directeur_etudes/historique_modification_note';
     });

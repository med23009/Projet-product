...
<tbody>
<tr>
<td style="width: 63.85pt; padding: 0cm 5.4pt 0cm 5.4pt;" width="85">&nbsp<img src="../../images/<?=$param_generaux[0]['logo']?>" height="70" width="90" ></td>
<td style="width: 31.35pt; padding: 0cm 5.4pt 0cm 5.4pt;" width="42">
<p style="line-height: normal;"><span style="font-size: 9.0pt; font-family: 'Arial','sans-serif';"><?=$param_generaux[0]['nom']?></span></p>
</td>
...
<p style="text-align: right; line-height: normal;"><span style="font-size: 9.0pt; font-family: 'Arial','sans-serif';">Ann&eacute;e Universitaire&nbsp;: <?php if($annee%2==0){  echo ($annee-1)."/".$annee; }else{echo $annee."/".$annee+1;}
                                                                 ?> </span></p>
</td>
</tr>
<tr><td align="center" colspan="3"><p><span id="sem" style="font-family: 'Arial','sans-serif';font-size: 16.0pt;"></span></p></td></tr>
</tbody>
</table>
...
<p style="text-align: right; line-height: normal;"><span style="font-size: 9.0pt; font-family: 'Arial','sans-serif';">Ann&eacute;e Universitaire&nbsp;: <?php if($annee%2==0){  echo ($annee-1)."/".$annee; }else{echo $annee."/".$annee+1;}?></span></p>
</td>
</tr>
<tr>
<td style="width: 255.2pt; padding: 0cm 5.4pt 0cm 5.4pt;" width="340">
<p style="margin-left: 35.4pt; text-align: justify; line-height: normal;"><strong><span style="font-size: 13.0pt; font-family: 'Arial','sans-serif';">Enseignement&nbsp;: </span></strong><spanB id="infp2" style="font-size: 11.0pt; font-family: 'Arial','sans-serif';">Fili&egrave;re&nbsp;, Semestre, Code, Intitul&eacute; Module, </span></p>
</td>
<td style="width: 10.0cm; padding: 0cm 5.4pt 0cm 5.4pt;" width="378">
<p style="margin-left: 35.4pt; line-height: normal;"><strong><span style="font-size: 13.0pt; font-family: 'Arial','sans-serif';">Enseignant&nbsp;: </span></strong><span id="nom2" style="font-size: 11.0pt; font-family: 'Arial','sans-serif';">Nom et pr&eacute;nom</span></p>
</td>
</tr>
<tr>
<td style="width: 255.2pt; padding: 0cm 5.4pt 0cm 5.4pt;" width="340">
<p style="margin-left: 35.4pt; line-height: normal;"><strong><span style="font-size: 13.0pt; font-family: 'Arial','sans-serif';">El&eacute;ment</span></strong><span id="elt2" style="font-size: 13.0pt; font-family: 'Arial','sans-serif';">, Code, Intitul&eacute;</span></p>
</td>
<td style="width: 10.0cm; padding: 0cm 5.4pt 0cm 5.4pt;" width="378">
<p style="margin-left: 35.4pt; line-height: normal;"><strong><span style="font-size: 13.0pt; font-family: 'Arial','sans-serif';">Dipl&ocirc;me</span></strong><span id="titreD2" style="font-size: 13.0pt; font-family: 'Arial','sans-serif';">&nbsp;: Titre, Universit&eacute;, Pays</span></p>
</td>
</tr>
</tbody>
</table>
   ...
   // document.getElementById('default').selected = 'selected';
                                          ...
                                          var session=$("#session").val();
                                                if (matricule == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/groupe_d_enseignent?matricule=" + matricule +"&annee="+annee+"&session="+session+ "";
   ...
   alert(counter.nom);
      selectBox.options.add(new Option(counter.matriculeEtudiant+" "+counter.nom+" "+counter.prenom,counter.matriculeEtudiant , option.selected));
         alert()                                          
            ...
            $('#nom2').html(counter.prenom+" "+counter.nom);
             $('#infp2').html(""+counter.idProgramme+" "+counter.semestre+ " "+counter.idModule+" "+counter.module);
             $('#elt2').html(": "+counter.sigle+" "+counter.titre);
            $('#titreD2').html(":  "+counter.dernierDiplome+" "+counter.paysDiplome);
            
            var tp=parseInt(counter.hrsTP);
            var td=parseInt(counter.hrsTD);
            var cm=parseInt(counter.hrsCours);
          //  var vp=parseInt(counter.volumeProjet);//add by MedBakar 25-03-2020
            var v=tp + td + cm ;//+ vp; +counter.volumeProjet+" VP "
                                            ...
                                            $('#taux').html(":<b> "+taux+"</b> ");
                                                  ...
                                                  var start= moment().startOf('isoWeek').format('YYYY-MM-DD'); 
                                                   var end=moment().endOf('isoWeek').format('YYYY-MM-DD');
                                                    var employe=$('#employe1').val();
                                                    var events = "<?php echo base_url(); ?>index.php/agent/afficher_etudiant_groupe_a?groupe=" + groupe + "&start="+start+"&end="+end+"&employe="+employe+"";

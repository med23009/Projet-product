...
<?php //  } ?>
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/agent/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "";
                                                    $('#startTime1').val(events);
                                                   // $('#calendar').fullCalendar('destroy');
                                                   $('#calendar').fullCalendar('removeEvents');
                                                    $('#calendar').fullCalendar('addEventSource', "<?php echo base_url(); ?>index.php/agent/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "");
                                                ...
                                                <div class="modal-body">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="field desc">
                                                            <input value="Cours" class="form-control" id="title" name="title" placeholder="Description" type="text" value="">
                                                        </div>
                                                    </div>
                                                    <script>
                                                        $(document).ready(function () {

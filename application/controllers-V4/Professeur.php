...
$info_etablissement= $this->scolarite_modele->Recup_Parametre_Generaux();
   ...
   function choix_session_exam($option = 'ex') {
    ...
    function afficher_cours_exam($option = 'ex') {
        ...
        //$tables = array("module", "planetudes", "unite");
        //$join_keys = array("planetudes.sigle = module.sigle ", "unite.sigle=module.sigleunite");
       // $db_columns = array('planetudes.sigle as sigleGroupe', 'module.titre as titreModule', 'unite.sigle as sigleUnite');
        $result_columns = array('sigleGroupe', 'titreModule', 'sigleUnite');
        $grid_columns = array('Sigle Elément', 'Titre', 'Sigle Unite');
...
//aadd        $where = "WHERE annee = " . $this->input->post('annee') . " AND groupe.semestre = " . $session ;

        $where = "WHERE annee = " . $this->input->post('annee') . " AND planetudes.semestre = " . $session ;

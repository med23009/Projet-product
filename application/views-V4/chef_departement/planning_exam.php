...
<script>
   ...
   var table=  $('#example').DataTable( {
        "ajax": "<?php echo base_url(); ?>index.php/chef_departement/info_plannig_exam",
        "columns": [
            { "data": "id" },
             { "data": "planning" }
    ...
    var crenau=    $('#crenau').val();
     ...
     $('#add').click( function () {
      ...
      $('#fiche').click( function () {
         ...
         window.location.href="<?php echo base_url(); ?>index.php/chef_departement/planning_examens?planing="+data.id+"&idProgramme="+idProgramme+"";
     });
 ...
 var data = table.row('.selected').data();
  ...
  <div class="container">
      <div class="col-xs-12 hl-left"><table><tr><td>
       <!-- <button class="btn btn-default btn-sm" id="add"><span class="glyphicon glyphicon-plus-sign"></span>Supprimer</button><!--<button class="btn btn-default btn-sm" id="delete"><span class="glyphicon glyphicon-trash"></span>Supprimer</button><button class="btn btn-default btn-sm" id="update"><span class="glyphicon glyphicon-edit"></span>Modifier</button>--><button class="btn btn-default btn-sm" id="fiche"><span class="glyphicon glyphicon-file"></span>Planning</button>         <div class="form-group">
              </td><td><select class="form-control"    name="idProgramme"  id="idProgramme" > 

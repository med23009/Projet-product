...
<div class="container" >
   ...
   <div class="center_content">
       ...
       <?php    echo form_open('agent/afficher_fiches_suivi');?>
       <table width="100%"><!--<tr> <td>Date:</td><td><input type="date" name="date" id="date"/></td><td>Heure Début:</td><td> <select class= 'form-control' name="heureD" id="heureD">
        ...
        if(is_array($programme['idProgramme']))
        {
            ...
            echo '</select>';
                ...
                <td align="right"> <td class="submit">

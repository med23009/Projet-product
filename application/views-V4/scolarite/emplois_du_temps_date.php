...
.fc-event-start {
 ...
 <!--add by MedBAkar 14-04-2020 pour ajuster le design --><style>
                body{
...
<?php //  } ?>
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index8.php/scolarite/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "";

   ...
   <div class="container">
    <div class="col-xs-12 hl-left">
         ...
         <?php echo heading($titre,'3');
           $attributes = array('class' => 'niceform');
                ...
                echo form_open('scolarite/afficher_liste_etudiants_decision_manuelle',$attributes);
    ...
    function get_session_nom($numeroSemestre)
    {
        ...
        else
        {
            ...
            <tr>
                 <td class="submit">
                 <?php $pw = array('type' => 'submit', 'name' => 'submit', 'id'=>'submit', 'value'=>'Liste des étudiants');
                 echo form_input($pw);?>
                 </td>
            </tr>
         </table>

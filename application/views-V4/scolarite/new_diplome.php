...
<button  onClick="imprimer('printable');" ><b> Imprimer le diplôme </b></button>
<div class="container">
...
.fyt8{font-style:normal;font-weight:bold;font-size:20px;font-family:Times New Roman;color:#000000;}
.ft9{font-style:normal;font-weight:bold;font-size:17.5px;font-family:Times New Roman;color:#000000;}
.fyt9{font-style:normal;font-weight:bold;font-size:12.5px;font-family:Times New Roman;color:#000000;}
...
.ft26{font-style:normal;/*font-weight:bold*/;font-size:17px;font-family:Sakkal Majalla;color:#000000;}
...
.ft2g{font-style:normal;font-weight:bold;font-size:25px;font-family:Sakkal Majalla;color:#000000;}
...
<div style="position:absolute;top:0;left:0"><img width="1170" height="820" src="<?php echo base_url();?>images/im11.png" ALT=""></div>
<div style="position:absolute;top:51;left:79"><span class="ft0"> </span></div>

<div style="position:absolute;top:45;left:79"><span class="fyt8">République Islamique de Mauritanie</span></div>
<div style="position:absolute;top:75;left:79"><span class="fyt9">Ministère de l'Enseignement Supérieur et de la Recherche Scientifique</span></div>
<div style="position:absolute;top:65;left:424"><span class="ft8"> </span></div>
<div style="position:absolute;top:96;left:79"><span class="fyt9">Université de Nouakchott Al Aasriya</span></div>
...
<div style="position:absolute;top:70;left:914px"><span class="ft26"> وزارة التعليم العالي والبحث العلمي</span></div>
<div style="position:absolute;top:90;left: 953px"><span size="1" class="ft26">جامعة نواكشوط العصرية</span></div>
<div style="position:absolute;top:105;left: 936px;"><span class="ft2g">المعهد الجامعي المهني</span></div>
...
<div style="position:absolute;top:168;left:575"><span class="ft16"><font color="fff"><?php echo $anneeD;?></font></span></div>
...
<div style="position:absolute;top:168;left:616"><span class="ft16"><font color="fff"><?php echo $anneeD+1;?></font></span></div>
...
<div style="position:absolute;top:297;left:438"><span class="ft15">N</span></div>
<div style="position:absolute;top:297;left:449"><span class="ft15">°</span></div>
<div style="position:absolute;top:198;left:455"><span class="ft15"> </span></div>
<div style="position:absolute;top:297;left:460"><span class="ft15">du Diplôme</span></div>
<div style="position:absolute;top:198;left:537"><span class="ft15"> </span></div>
<div style="position:absolute;top:297;left:541"><span class="ft15">:</span></div>
...
<div style="position:absolute;top:297;left:570"><span class="ft16">_________</span></div>
<div style="position:absolute;top:297;left:570"><span class="ft16"><font color="fff"><?php echo ''.$info['matriculeEtudiant'] ; ?></</font></span></div>
...
<?php //echo "../../photos/IUP".$info['matriculeEtudiant'].'.bmp';?>
  <div style="position:absolute;top:202;left:272">       <img style="width: 90px; height: 88px;" src="<?php
        
       if(file_exists("C:\wamp\www\Laureat\photos\photos\IUP".$info['matriculeEtudiant'].'.GIF'))
          echo base_url()."/photos/IUP".$info['matriculeEtudiant'].'.GIF';
        else echo base_url()."/photos/IUP".$info['matriculeEtudiant'].'.bmp'; 
   ?> "onerror="this.src='<?php echo base_url();?>/photos/default.gif';"/></div>
<div style="position:absolute;top:297;left:658"><span class="ft14">  رقم الشهادة</span></div>
<div style="position:absolute;top:297;left:650"><span class="ft14">:</span></div>
...
//echo $i;
//}
$nom = $info['prenom']." ".$info['prenomPere']." ".$info['nom'];
$space = " ";
$lastPos = 0;
$positions = 0;
...
<div style="position:absolute;top:396;right:220"><span class="ft2i">      
  ...
  <?php echo  $info['prenomArabe']." ".$info['prenomPere_ar']." ".$info['nomArabe']; ?></span></div>
...
<div style="position:absolute;top:402;right:169"><span class="ft22">
        :
        <?php
            // F_M 
            if($info['genre']=="F"){
...
<div style="position:absolute;top:426;left:79"><span class="ft22">Né<?php 
    // F_M 
        if($info['genre']=="F"){
            echo "e";
        }elseif($info['genre']=="M"){
...
<div style="position:absolute;top:426;left:<?php /*F_M*/ if($info['genre']=="F")echo "120px";elseif($info['genre']=="M")echo"114px"?>"><span class="ft22">:</span></div>
<div style="position:absolute;top:426;left:147"><span class="ft22"> </span></div>
<div style="position:absolute;top:430;left:200"><span class="ft2p">  <?php $format_date = date("d-m-Y", strtotime($info['dateNaissance'])); echo $format_date; ?></span></div>
...
<div style="position:absolute;top:430;left:330"><span class="ft2p"> <?php echo $info['lieuNaissance'];?></span></div>
...
<div style="position:absolute;top:416;right:340"><span class="ft2i">
        <?php // Pour afficher le lieu de naissance en arabe sur le diplome ?>
        <?php
//            $sql_lieu_ar="SELECT lieunaissance_ar FROM etudiant WHERE matriculeetudiant ='".$info['matriculeEtudiant']."'";
//            $res_lieu_ar = $this->db->query($sql_lieu_ar);
//            if ($res_lieu_ar->num_rows() > 0)
//            {
//                $res_lieu_ar_valeur=$res_lieu_ar->row_array();
//                $lieunaissance_ar=$res_lieu_ar_valeur['lieunaissance_ar'];
//            }else $lieunaissance_ar=$info['lieuNaissance'];
//        ?>
        <?php echo $info["lieuNaissance_ar"] ;?></span></div></span></div>
<!--469-->
...
<div style="position:absolute;top:430;right:220"><span  class="ft2p"> <?php $format_date = date("d-m-Y", strtotime($info['dateNaissance'])); echo $format_date; ?></span></div>
...
<div style="position:absolute;top:424;right:98"><span class="ft22"> المولود<?php
    // F_M 
    if($info['genre']=="F"){echo"ة";} ?></span></div>
<?php 
    if($info['genre']=="F"){}
    elseif($info['genre']=="M"){
        echo "";
...
?>
<!-- changement de la position at right -->
<div style="position:absolute;top:424;right:<?php if($info['genre']=="M") echo "137px"; else echo "142px" ?>"><span class="ft22">: بتاريخ </span></div>
<!--<div style="position:absolute;top:424;right:<?php if($info['genre']=="M") echo "169px"; else echo "185px" ?>"><span class="ft22">:</span></div>-->
<div style="position:absolute;top:447;left:79"><span class="ft22">Inscrit<?php 
    // F_M 
        if($info['genre']=="F"){
            echo "e";
        }elseif($info['genre']=="M"){
...
<div style="position:absolute;top:448;left:250"><span class="ft2p"> <?php echo 'IUP'.$info['matriculeEtudiant'] ; ?></span>&nbsp;&nbsp;&nbsp;<span class="ft22">:المسجل<?php
    ...
    if($info['genre']=="F"){
        ...
        تحت الرقم </span><span class="ft22">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Numéro National d'Identification (NNI):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ''.$info['nin'] ; ?></span></div>
...
<div style="position:absolute;top:445;right:98"><span class="ft22">الرقم الوطنى للتعريف</span></div>
<div style="position:absolute;top:445;right:138"><span class="ft22"></span></div>
<div style="position:absolute;top:445;right:143"><span class="ft22"></span></div>
<div style="position:absolute;top:445;right:148"><span class="ft22"></span></div>
<div style="position:absolute;top:445;right:158"><span class="ft22"></span></div>
...
<div style="position:absolute;top:469;left:430"><span class="ft9">Professionnelle</span></div>
<div style="position:absolute;top:492;left:510"><span class="ft9"> </span></div>
<div style="position:absolute;top:467;left:625"><span class="ft22" style="font-size:20px">  الليصانص  المهنية</span></div>
...
<div style="position:absolute;top:497;left:200"><span class="ft2p"> Sciences et Technologie</span></div>
...
<div style="position:absolute;top:484;right:220"><span class="ft2i">العلوم والتكنولوجيا</span></div>
...
<div style="position:absolute;top:520;left:200"><span class="ft2p"> <?php if($info["idProgramme"]=="MAN"){echo "Management";}else{ echo $info["programme"]; } ?></span></div>
...
<div style="position:absolute;top:506;right:220"><span class="ft2i"> <?php if($info["idProgramme"]=="MAN"){echo "إدارة المؤسسات";}else{ echo $info["programmeArabe"]; }   ?></span></div>
...
<div style="position:absolute;top:565;left:200"><span class="ft2p"> <?php echo $mention; ?></span></div>

<div style="position:absolute;top:537;left:516"><span class="ft23"> </span></div>
<div style="position:absolute;top:560;right:220"><span class="ft23"> ___________________________________</span></div>
<div style="position:absolute;top:552;right:220"><span class="ft2i"><?php echo  $mention1; ?></span></div>
...
<div style="position:absolute;top:543;left:200"><span class="ft2p"> <?php if($info["idProgramme"]=="MAN"){echo "Management";}else{ echo $info["programme"]; } ?></span></div>

<div style="position:absolute;top:537;left:516"><span class="ft23"> </span></div>
<div style="position:absolute;top:538;right:220"><span class="ft23"> ___________________________________</span></div>
<div style="position:absolute;top:530;right:220"><span class="ft2i"> <?php if($info["idProgramme"]=="MAN"){echo "إدارة المؤسسات";}else{ echo $info["programmeArabe"]; }  ?></span></div>
...
<div style="position:absolute;top:615;left:300"><span class="ft2_"> رئيس جامعة نواكشوط العصرية</span></div>
<div style="position:absolute;top:615;left:299"><span class="ft28"> .</span></div>

<div style="position:absolute;top:615;left:750"><span class="ft28"> مدير المعهد الجامعي المهني</span></div>

<div style="position:absolute;top:642;left:200"><span class="ft30">Le Président de l’Université de Nouakchott Al Aasriya</span></div>
<div style="position:absolute;top:642;left:616"><span class="ft30"> </span></div>
<div style="position:absolute;top:642;left:662"><span class="ft30"> Le Directeur de l’Institut Universitaire Professionnel</span></div>
<div style="position:absolute;top:642;left:977"><span class="ft30"> </span></div>
<div style="position:absolute;top:660;left:388"><span class="ft26j"> أحمدو</span></div>
<div style="position:absolute;top:660;left:355"><span class="ft26j">حوبّه</span></div>
<div style="position:absolute;top:645;left:418"><span class="ft26">  </span></div>
<div style="position:absolute;top:686;left:328"><span class="ft31">Ahmedou H</span></div>
<div style="position:absolute;top:686;left:403"><span class="ft31">AOUBA</span></div>
<div style="position:absolute;top:645;left:535"><img width="120" height="50" src="<?php echo base_url();?>images/tampon.png" ALT=""></div>
<div style="position:absolute;top:666;left:448"><span class="ft31"> </span></div>
<div style="position:absolute;top:660;left:762"><span class="ft26j"> الشيخ أحمد اعْلِ أحمد</span></div>
<div style="position:absolute;top:645;left:877"><span class="ft26"> </span></div>
<div style="position:absolute;top:686;left:737"><span class="ft31"><b>Cheikh </b></span></div>
<div style="position:absolute;top:686;left:786"><span class="ft31"><b>Ahmed ELY AHMED</b></span></div>

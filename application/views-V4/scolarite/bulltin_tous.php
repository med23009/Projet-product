...
$(".barcode").JsBarcode("<?php echo  $info['matriculeEtudiant'];?>",{
width:0.5,
height:30,
quite: 10,
format:"CODE128",
...
<TR>
	...
	<TD colspan=4 class="tr0 td9"><P class="p0 ft8"><?php echo $info['programme'];?></P></TD>
</TR>
<TR>
	<TD class="tr8 td0"></TD>
...
<TR>
	<TD class="tr9 td10"><P class="p0 ft12" >Prénom du Père</P></TD>
	<TD class="tr9 td11"><P class="p4 ft12">:</P></TD>
...
<TR>
	...
	<TD class="tr11 td12"><P class="p5 ft13"><?php echo  $info['matriculeEtudiant'];?></P></TD>
</TR>
<TR>
...
<!--	<TD class="tr13 td46"><P class="p0 ft18">&nbsp;</P></TD>
	...
	<!--<TD rowspan=3 class="tr8 td47"><P class="p11 ft15" style="text-align: center">Atome</P></TD>-->
	<!--  -->
<!--ici commante par scolarite team-->
...
echo'<TR>
   ...
   <!-- a verifier     <TD class="tr12 td4"><P class="p29 ft16" >'.(!empty($module) && !empty($module['ects'])?$module['ects']:0).' ['.(!empty($module) &&!empty($module['coefficient'])?$module['coefficient']:0).']'.'</P></TD>
...
echo '<TD class="tr17 td52"><P class="p28 ft16">'.$element['nfe'][$k].'</P></TD>';
...
//	<TD class="tr17 td50" colspan=1><P class=" ft16" style="text-align:center;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;">'.number_format($element['ncc'][$k],2).'</P></TD>
...
//	<TD class="tr17 td45"><P class="p29 ft16">'.$element['ects'][$k].' ['.$element['coefficient'][$k].']</P></TD>
//	<TD class="tr17 td50" colspan=1><P class=" ft16" style="text-align:center;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;">'.number_format($element['ncc'][$k],2).'</P></TD>';
//	<TD class="tr17 td55"><P class="p11 ft16">DS</P></TD>
//	echo'<TD class="tr17 td56"><P class="p28 ft16">'.number_format($element['nsn'][$k],2).'</P></TD>';
        //////                          if(number_format($element['nsr'][$k],2)=="0.00"){
...
<TR>
	...
	<TD colspan=1 rowspan=1 class="tr19 td76"><P class="p23 ft15">TOTAL CRÉDIT CAPITALISÉ</P></TD>
	<TD colspan=1  class="tr0 td77"><P class="p0 ft1">&nbsp;</P></Tr><!--	<TD class="tr0 td44"><P class="p0 ft1">&nbsp;</P></TD>
	<TD colspan=3 rowspan=2 class="tr19 td76"><P class="p23 ft15">TOTAL CRÉDIT CAPITALISÉ</P></TD>
-->	<!--<TD class="tr0 td77"><P class="p0 ft1">&nbsp;</P></TD>-->

	<TD class="tr0 td42"><P class="p0 ft1">&nbsp;</P></TD>
	<TD rowspan=2 class="tr21 td78"><P class="p28 ft30"><?php echo (!empty($semestre['ects'])?$semestre['ects']:0);?></P></TD>
        <TD colspan=2 rowspan="2"class="tr0 td79"><P class="p11 ft15">MOYENNE SEMESTRE</P></TD>
	<TD rowspan=2 class="tr21 td72"><P class="p28 ft31"><?php echo (!empty($semestre['note'])?$semestre['note']:0);?></P></TD>
...
<TR>
	...
	<TD colspan=2 class="tr10 td92"><P class="p0 ft16">ÉTAT DE VALIDATION DU SEMESTRE :</P></TD>
         <?php //on modifie la decision vers valide ou non au lieu admis /ajourne add by MedBakar 14-03-2020
        $decision='';
        if(!empty($semestre['decision'])){
        $decision='Validé';
        if($semestre['decision']=='Ajourné(e)') $decision='Non validé';}
        ?>
...
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L1(crédit<sub>s1</sub>+crédit<sub>s2</sub>)>=<?php echo$regle_passage[4][1]['ECTSL1']?></span></p>
</td>
</tr>
<?php }elseif($niveau=="2"){ ?>
<tr style="height: 13.5pt;">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L1(crédit<sub>s1</sub>+crédit<sub>s2</sub>)=<?php echo$regle_passage[4][2]['ECTSL1'] ?></span></p>
</td>
</tr>
<tr style="height: 13.5pt;">
    <td style="width: 5.0pt; border: solid #E36C09 1.0pt; border-top: none; border-bottom: none; border-right: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L2(crédit<sub>s3</sub>+crédit<sub>s4</sub>)>=<?php echo $regle_passage[4][2]['ECTSL2']?></span></p>
</td>
</tr>
<?php }elseif($niveau=="3"){ ?>
<tr style="height: 13.5pt;">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L1(crédit<sub>s1</sub>+crédit<sub>s2</sub>)=<?php echo $regle_passage[4][3]['ECTSL1'] ?></span></p>
</td>
</tr>
<tr style="height: 13.5pt;">
    <td style="width: 5.0pt; border: solid #E36C09 1.0pt; border-top: none; border-bottom: none; border-right: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L2(crédit<sub>s3</sub>+crédit<sub>s4</sub>)=<?php echo $regle_passage[4][3]['ECTSL2'] ?></span></p>
</td>
</tr>
<tr style="height: 13.5pt;">
    <td style="width: 5.0pt; border: solid #E36C09 1.0pt; border-top: none; border-bottom: none; border-right: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
...
<td style="width: 123.25pt; border-top: none; border-left: none;  border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 7.0pt;">TOTAL crédit L3(crédit<sub>s5</sub>+crédit<sub>s6</sub>)=<?php echo $regle_passage[4][3]['credit']-($regle_passage[4][3]['ECTSL1']+$regle_passage[4][3]['ECTSL2']); ?></span></p>
</td>
</tr>
<?php }?>
...
<td style="width: 123.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
    <p style="margin-top: 0cm;"><span style="font-size: 7.0pt; font-family: 'Times New Roman','serif';"><B></span></p>
            ...
            <?php if($numSem%2==0 and $numSem>=$max_semestre){  /*Begin add by MedBakar 15-08-2020*/ $redoublement=false;$admis=0; /*End new add by MedBakar 15-08-2020*/?>
...
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total crédit L<?php echo $niveau; ?></span></p>
</td>
...
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php if(  $moyenne['ECTSL1']>= $regle_passage[4][1]['ECTSL1']){ echo "V"; $admis++;}else{ echo "NV"; $redoublement=true;} ?></span></p>
</td>
</tr>
...
<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total crédit L<?php  echo $niveau-1; ?></span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL1'] ?></span></p>
</td>
<td style="width: 20.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php  if( $moyenne['ECTSL1']>=$regle_passage[4][2]['ECTSL1']){ echo "V"; $admis++;}else{ echo "NV"; $redoublement=true;} ?></span></p>
</td>
</tr>

<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total crédit L<?php  $info['niveau']=($numSem+1)/2;echo ''. substr($info['niveau'], 0,1)  ; ?></span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL2'] ?></span></p>
</td>
<td style="width: 20.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php  /*$reg=30; if($passage['regle']==2){$reg=39;}*/if( $moyenne['ECTSL2']>=$regle_passage[4][2]['ECTSL2']){ echo "V"; $admis++; }else{ echo "NV"; $redoublement=true;} ?></span></p>
</td>
</tr>
...
<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total crédit L1</span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL1'] ?></span></p>
</td>
<td style="width: 20.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php  if( $moyenne['ECTSL1']==$regle_passage[4][3]['ECTSL1']){ echo "V"; $admis++; }else{ echo "NV"; $redoublement=true;} ?></span></p>
</td>
</tr>

<tr style="height: 13.5pt;">
<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total crédit L2</span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL2'] ?></span></p>
</td>
<td style="width: 20.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php  if( $moyenne['ECTSL2']==$regle_passage[4][3]['ECTSL2']){ echo "V"; $admis++;}else{ echo "NV"; $redoublement=true;} ?></span></p>
</td>
</tr>

<td style="width: 54.0pt; border: solid #E36C09 1.0pt; border-top: none; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="72">
<p style="margin: 1.45pt 0cm .0001pt 1.55pt;"><span style="font-size: 8.0pt;">Total crédit L3</span></p>
</td>
<td style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php echo $moyenne['ECTSL3'] ?></span></p>
</td>
<td style="width: 20.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
<p style="margin: .9pt 0cm .0001pt 12.0pt;"><span style="font-size: 9.0pt;"><?php  if( $moyenne['ECTSL3']==$regle_passage[4][3]['credit']-($regle_passage[4][3]['ECTSL1']+$regle_passage[4][3]['ECTSL2'])){ echo "V"; $admis++;}else{ echo "NV"; $redoublement=true;} ?></span></p>
</td>
</tr>
...
<td colspan="2" style="width: 40.25pt; border-top: none; border-left: none; border-bottom: solid #E36C09 1.0pt; border-right: solid #E36C09 1.0pt; background: #DBEDF3; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="164">
    <p style="margin-top: 5PX;text-align: center"><span style="font-size: 7.0pt; font-family: 'Times New Roman','serif';"><B>
        <?php if($redoublement){echo"REDOUBLEMENT";}ELSE{if($admis==3){echo "VALIDATION";}ELSE{echo"PASSAGE en L".(++$niveau);} } //add by MedBakar 15-08-2020 ?>
        <?php //  if($passage['niveau']>$niveau){ if($numSem==6){echo "VALIDATION";}ELSE{echo"PASSAGE en L".$passage['niveau'];}}else{echo"REDOUBLEMENT";}?>
            </b></span></p>
</td>
...
<TR>
	<TD rowspan=3 class="tr23 td109"><!--[if lte IE 7]><P style="margin-left:-16px;margin-top:0px;margin-right:-25px;margin-bottom:0px;" class="p31 ft17"><![endif]--><!--[if gte IE 8]>
<P style="margin-left:25px;margin-top:0px;margin-right:-66px;margin-bottom:41px;" class="p31 ft17"><![endif]--><![if ! IE]>
<P style="margin-left:9px;margin-top:21px;margin-right:-50px;margin-bottom:20px;" class="p31 ft17"><![endif]>DECISION</P></TD>
	<TD class="tr5 td110"><P class="p0 ft1">&nbsp;</P></TD>
        <TD colspan=2 class="tr5 td111"><P class="p0 ft17">FAIT &Aacute; NOUAKCHOTT, LE <?php echo date('d/m/Y');?></P></TD>
...
<TR>
	<TD class="tr19 td117"><P class="p0 ft1">&nbsp;</P></TD>
        <TD colspan=2 rowspan=2 class="tr24 td118"><P class="p11 ft32"><NOBR><?php if($semestre['ects']==30){echo 'VALIDATION';}else{ echo 'AJOURNEMENT'; } ?> </P></TD>
...
<TR>
    <TD class="tr2 td134"><P class="p0 ft17">RELEV&Eacute; DE NOTES DE :</P></TD>
    <TD class="tr2 td135"><P class="p0 ft20" style="font-size:12px "><?php echo $info['nom'].' '. $info['prenom'] ;?></P></TD
</TR>
</TABLE>
...
newwin.document.write('<TITLE>'+'Relevé_de_Note'+'_Matricule<?= $info['matriculeEtudiant'];?>'+'</TITLE>\n')

        ...
        <div id="printable">
          ...
          <table  width="100%" style="border-spacing: 4px; marign: 20px 20px 20px; border-bottom: 2px solid #E26C09;border-top: 2px solid #E26C09;font-family:Times; font-size:11.25px;line-height: 12px; " cellspacing="0"> 
             ...
             <tr>
               ...
               <td id="contenu"><?php $niveau1=$niveau+2; echo 'Niveau : '. $niveau1 .'<sup>ème</sup> année' ;  ?></td>
             ...
             <tr>
               ...
               <td id="contenu"></td>
                ...
                <td id="contenu"><strong></strong></td>
...
newwin.document.write('<TITLE>Fiche_Ins_pedag_'+'<?php echo $info['programme']; ?>'+'<?php echo $info['matriculeEtudiant'] ; ?>'+'_L'+'<?=$niveau?>'+'_'+'<?php echo($annee."-".($annee +1));?>'+'</TITLE>\n')

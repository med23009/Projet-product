...
<div class="container">
    ...
    <div class="col-xs-12 hl-left">
        ...
        <div class="row vdivide">
            ...
            <h3 class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >Correction de la note eliminatoire  </h3>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <?php
                $attributes=array('id'=>'formulaire');
                echo form_open('administrateur/correction_notes_eliminatoires/' . $cycle,$attributes);
                ?>
                <br>
                <table class="table" >
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <button  class="btn btn-success"  onclick="setFormValues('note_matiere','matiere')">Enregistrer</button>
                        </td>
                    </tr>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <table class="table" >
                    ...
                    <tr>
                        <td colspan="2">
                            <button  class="btn btn-success"  onclick="setFormValues('note_module','module')">Enregistrer</button>
                        </td>
                    </tr>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <table class="table" >
                    ...
                    <tr>
                        <td colspan="2">
                            <button  class="btn btn-success"   onclick="setFormValues('note_semestre','semestre')">Enregistrer</button>
                        </td>
                    </tr>

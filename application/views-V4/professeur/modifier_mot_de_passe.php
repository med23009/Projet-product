<?php include(APPPATH.'views/include/header.php');
 ...
 <div class="container">
   ...
   <div class="warning_box" >
              Le nouveau mot de passe doit contenir 8 à 10 caractères dont au moins une lettre et un chiffre.
          </div>
         <div class="form">
          <?php $attributes = array('class' => 'niceform');
         
          echo form_open('professeur/modifier_mot_de_passe',$attributes);?>

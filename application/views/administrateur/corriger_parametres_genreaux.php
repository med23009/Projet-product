...
<div class="container">
    ...
    <div class="col-xs-12 hl-left">
        <h2>Corriger les Paramètres Généraux</h2>
            <br>
            <div>dernieur date d'activation: <span class="label label-default"><?php echo $parametres['date_d'];?></span></div>
        ...
        ?>
        <?php echo form_open_multipart('administrateur/correction_parametres_generaux'); ?>

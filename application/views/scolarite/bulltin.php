...
<?php include(APPPATH.'views/include/header.php');
    ...
    ?>
<a href="<?php echo base_url();?>index.php/scolarite/choix_semestre_bulltin_new/<?php echo  $info['matriculeEtudiant'];?>" ><button id="btn">choisir un autre semestre</button></a>
  <div class="container">
...
//          }
          ?>
	<TD colspan=4 class="tr0 td9"><P class="p0 ft8"></P></TD>
</TR>
<TR>
	<TD class="tr6 td0"></TD>
...
<TR>
	<TD class="tr8 td0"></TD>
        <TD class="tr8 td1"><P class="p2 ft11"> ANNÉE ACADÉMIQUE <NOBR><?php if($numSem%2==1){ echo  $annee.'-'.($annee+1);}else{echo ( $annee-1).'-'.($annee);}?></NOBR></P></TD>
	<TD class="tr8 td2"><P class="p0 ft7">NIVEAU</P></TD>
        <TD class="tr8 td3"><P class="p0 ft12"><?php  $info['niveau']=($numSem+1)/2 +2;  echo substr($info['niveau'], 0,1) .' <sup>ème</sup> année' ; ?></P></TD>
...
<TR>    
	<TD width="5px" height="5px" class=""><P class="p0 ft18">&nbsp;</P></TD>
        <TD colspan="2" align="center" style=""><P class="p0 ft19">&nbsp;</P>
            ...
            if(file_exists(FCPATH."photos/". $info['matriculeEtudiant'].'.GIF'))
        echo "../../photos/".$info['matriculeEtudiant'].'.GIF';
        else 
            if(file_exists(FCPATH."photos/". $info['matriculeEtudiant'].'.bmp'))
               echo "../../photos/".$info['matriculeEtudiant'].'.bmp';
            else 
                if(file_exists(FCPATH."photos/". $info['matriculeEtudiant'].'.jpg'))
...
<P class="p17 ft16">T&eacute;l&eacute;phone : <?php echo $infoE['telephone1']; ?></P>
...
<TR>
	<TD class="tr19 td117"><P class="p0 ft1">&nbsp;</P></TD>
        <TD colspan=2 rowspan=2 class="tr24 td118"><P class="p11 ft32"><NOBR><?php if(!empty($semestre['ects'])) if($semestre['ects']==30){echo 'VALIDATION';}else{ echo 'Non validé'; } ?> </P></TD>
...
--><P class="p33 ft12">du Directeur des Études</P>                
</td></tr>
            <tr>
                <td height="100px">
...
newwin.document.write('<TITLE>Relevé-S'+'<?=$numSem?>'+'_Matricule<?= $info['matriculeEtudiant'];?>'+'_<?php  if($numSem%2==1){ echo  $annee."-".($annee+1);}else{echo ( $annee-1)."-".($annee);}?>'+'</TITLE>\n')

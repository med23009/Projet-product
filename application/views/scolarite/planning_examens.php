...
<tbody>
    <tr><td align="center" colspan="16"><div id="parallelogram"><br>Planning des Examens de la Filière : <b><?php echo " ".$idProgramme1; ?></b> [Session : SN] du 21/01/2019 au 26/01/2019<br>  
...
$heurD=array(8,10,12,15); $planning=(Array)$planning;?>
...
location.reload();
       ...
       $('#update').click( function () {
         window.location.href='<?php echo base_url(); ?>index.php/scolarite/modifier_planning_exam?planing=<?php /*AZDEBUT*/ echo $planing; /*AZFIN*/?>';
       // $('#createEventModal1').modal('toggle');
     });

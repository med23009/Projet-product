   ...
   var table=  $('#example').DataTable( {
    ...
    $('#example tbody').on( 'click', 'tr', function () {
       /* if ( $(this).hasClass('selected') ) {
        ...
        var matriculeEtudiant=table.row( this ).data().matriculeEtudiant;
        var sigle=table.row( this ).data().sigle;
        var idEvaluation=table.row( this ).data().idEvaluation;
        var semestre=table.row( this ).data().semestre;
        var note=table.row( this ).data().note;
        var annee=table.row( this ).data().annee;

<?php include(APPPATH.'views/include/header.php');
 ...
 <div class="container">
    <div class="col-xs-12 hl-left">
         ...
         <?php echo heading('Génération des fiches d\'inscription','2');       
           echo form_open('scolarite/generer_ficheInscription');
         ?>
        ...
        <div>
            <table style="width: 400px;">
                ...
                <tr>
                    ...
                    <td><?php echo form_label('Niveau<span style="color:red;font-weight:bold;font-size:14px;">*</span>'); ?> 
                </td>
                <td><select  name="niveau">

                        
                        <?php
                        echo '<option value="1"> L1</option>'. "\n";
                        ?>
                        <?php
                        echo '<option value="2"> L2</option>'. "\n";
                        ?>
                        <?php
                        echo '<option value="3"> L3</option>'. "\n";
                        echo '</select>';
                        ?>

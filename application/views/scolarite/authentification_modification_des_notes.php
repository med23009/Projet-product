...
<div class="container">
    <div class="col-xs-12 hl-left">
        ...
        <h3>Authantification pour la modification dees notes eliminatoires | <?php echo $type; ?> </h3>
        <!--formualire authantification pour la modification des notes-->
        <div class="formualire_authantification_modification_des_notes">
            <?php
            echo form_open('scolarite/authentification_modification_des_notes/'.$operation.'/' . $type);
            ?>

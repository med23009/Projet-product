...
<a href="<?php echo base_url();?>index.php/scolarite/trouver_etudiant_bulletin_historique_new" ><button id="btn">choisir un autre etudiant</button></a>
 <div class="container">
    <div class="col-xs-12 hl-left">
         ...
         <?php echo heading($titre,'3');
           $attributes = array('class' => 'niceform');
                ...
                echo form_open('scolarite/voir_bulletin_new',$attributes);

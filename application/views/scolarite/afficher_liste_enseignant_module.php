<?php include(APPPATH.'views/include/header.php');
 ...
 <button  onClick="imprimer('printable');" style="float:right; height: 30px; background-color:#cceac4; width: 160px; margin-right:185px; margin-top:50px;"><b> Imprimer la liste </b></button>
     <?php
        ...
        echo form_open('scolarite/generer_excel_liste_enseingant_module', $attributes);
        ?>
    ...
    function get_session_nom($numeroSemestre) {
        if ($numeroSemestre == 3) {
            ...
            return 'Printemps';
                    ...
                    {
                        echo "<tr>
                        <td>".$infoEnseignant['matriculeEmploye'][$i]."</td>
                        <td>".$infoEnseignant['prenom'][$i]."</td>
                        <td>".$infoEnseignant['nom'][$i]."</td>
                        <td>".$infoEnseignant['sigle'][$i]."</td>
                        <td>".$infoEnseignant['annee'][$i]."</td>
                        <td>".get_session_nom($infoEnseignant['semestre'][$i])."</td>
                        </tr>";

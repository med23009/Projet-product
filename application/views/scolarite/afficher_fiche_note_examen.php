    ...
    <tr>
                ...
                if(substr($groupe,strpos ($groupe,'-')+5,strpos ($groupe,'-',2))==3){
                    ...
                    $annee_univ=(substr($groupe,strpos ($groupe,'-')+1,strpos ($groupe,'-',2))-1).'-'.(substr($groupe,strpos ($groupe,'-')+1,strpos ($groupe,'-',2)));
                         ...
                         <td>
                             <table >
                                 <tr><td colspan= "1" style="background-color:#E26C09;border-radius: 10px 60px 15px 60px;font-size: 10px">
                                ...
                                <tr>
                                    <td><span style="font-size: 8.0pt;font-family: Arial,serif;">&nbsp; Moyenne de connaissance &nbsp;</style></td>
                                 </tr>
...
echo '</table>';
 ...
 ?>    
           ...
           <table align="center">
               ...
               {?>
               <td valign="top">
           <table id="example" border="1" cellspacing="10" width="80%" >
...
<p style="margin-top: 0cm;"><span style="font-size: 11.0pt; font-family: 'Arial','serif';">&nbsp  Attention :</span></p>
</td>
<td style="width: 501.35pt; border: solid #E36C09 1.0pt; border-left: none; background: #FCE9D9; padding: 0cm 0cm 0cm 0cm; height: 13.5pt;" width="660">
<p style="margin: 2.05pt 0cm .0001pt 8.95pt;"><span style="font-size: 9.0pt;font-family: 'Arial','serif';"> Veuillez, avant de signer, comparer le nombre de copies avec le nombre de notes figurant sur la fiche de notes
              </span></p>
</td>
</tr>
</tbody>
                 ...
                 <div id="observations" align="center">
                    <fieldset align="center" style="border:solid 1px black; padding:20px; width:500px; height:100px; color:midnightblue; font-family:Arial;" >
...
newwin.document.write('<TITLE>FicheNoteExamSN-'+'<?php echo $sigle;?>'+'</TITLE>\n')

...
<div class="container" >
   ...
   <div class="center_content">
       ...
       <?php    echo form_open('agent/afficher_paiement_heures');?>
       <table width="100%"><tr> <td>Date debut:</td><td><input type="date" name="dateD" id="dateD"/></td><td>Date fin:</td><td><input type="date"  name="dateF" id="dateF"/></td><td>Statut:</td><td><select class="form-control" onchange="" name="statut" id="statut" >
                   ...
                   </select> </td><td align="right"> <td class="submit">

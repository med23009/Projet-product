 ...
 <div class="container">
    <div class="col-xs-12 hl-left"> 
         ...
         echo heading('Saisir/modifier les notes','3');
            ...
            echo heading('Valider les notes','3');
       echo' <br><br><br>';
        //echo heading('Veuillez choisir l\'année et le semestre','3');


           $attributes = array('class' => 'niceform1');

          echo form_open('professeur/afficher_cours_cc',$attributes);
            ?>
        ...
        <?php                if(is_array($programme['idProgramme']))
        {
            ...
            echo '</select>';
                ...
                <tr>
                 ...
                 <tr>
                 <td class="submit">
                 <?php $pw = array('type' => 'submit', 'name' => 'submit', 'id'=>'submit5', 'value'=>'Suivant','class'=>"btn btn-success p-3");
                 echo form_input($pw);?>
                 </td>
            </tr>

...
//}
                        ...
                        eventDrop: function (event, delta) {
                            $.ajax({
                                url: '<?php echo base_url(); ?>index.php/scolarite/emplois_du_temps',
...
console.log('action=delete&id=' + eventID +' &id_D=' + eventID_D + '&rd=' + rd + '&type=' + type + '&prof=' + prof +'&profD=' + profD + '&local=' + local + '&localD=' + localD + '&eventIDG_D=' + eventIDG_D +'&type1=' + typeS +'&typeD=' + typeD + '&eventIDG=' + eventIDG + '&title=' + title +'&titleD=' + titleD +'&start=' + start + '&end=' + end+'&startD=' + startD + '&endD=' + endD+ '&typecm=' + typecm+'&typecmD=' + typecmD);
                        $.ajax({
                            url: '<?php echo base_url(); ?>index.php/scolarite/emplois_du_temps',
    ...
    chekb = $('#chek').val(); //alert(chekb); //hebdomadaire
} else {
    chekb="0"; //alert(chekb);
}
    ...
    chk1=$('#chk1').val(); //alert(chk1);  //remplacer prof
} else {
    chk1="0";// alert(chk1);
}
                        ...
                        $.ajax({
                            url: '<?php echo base_url(); ?>index.php/chef_departement/emplois_du_temps',
                                        ...
                                        <script>
                                            ...
                                            function showUser(str) {
                                                ...
                                                if (str == "1") {
                                                    ...
                                                    document.getElementById("cours").innerHTML = "<h2>Emploi du temps du  Semestre " + semestre1 + "  Filière " + idProgramme1 + " </h1>";
                                                    selectModule(type = 1);
                                                } else if (str == "2") {
...
<?php //  } ?>
                                                    ...
                                                    document.getElementById("cours").innerHTML = "<h2>Emploi du temps du  professeur  <div id='DIV2'></div> ";
                                                } else if (str == "3") {
                                                    selectModule(type = 3);
                                                    var local = $("#local1").val();
                                                    $("#local").html("<option value='" + local + "'>" + local + "</option>");

                                                    document.getElementById("cours").innerHTML = "<h2>Emploi du temps de la salle " + local1+" ";
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/chef_departement/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "";
                                                    $('#startTime1').val(events);
                                                   // $('#calendar').fullCalendar('destroy');
                                                   $('#calendar').fullCalendar('removeEvents');
                                                    $('#calendar').fullCalendar('addEventSource', "<?php echo base_url(); ?>index.php/chef_departement/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "");
                                                   // alert('hello mab');
...
//$('#calendar').fullCalendar( 'removeEvents' );
                                            ...
                                            $('body').on('click', 'button.fc-prev-button', function () {
                                                ...
                                                if (str == "1") {
                                                    ...
                                                    document.getElementById("cours").innerHTML = "<h1>Emploi du temps du  Semestre " + semestre1 + "  Filière " + idProgramme1 + "</h1>";
                                                    selectModule(type = 1);
                                                } else if (str == "2") {
                                                    //var node=  document.getElementById("ens");
                                                    // var textContent = node.textContent;
...
<?php //  } ?>
                                                    ...
                                                    document.getElementById("cours").innerHTML = "<h1>Emploi du temps du  professeur <div id='DIV2'></div> ";
                                                } else if (str == "3") {
                                                    selectModule(type = 3);
                                                    var local = $("#local1").val();
                                                    $("#local").html("<option value='" + local + "'>" + local + "</option>");

                                                    document.getElementById("cours").innerHTML = "<h1>Emploi du temps de la salle " + local1;
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/scolarite/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "";
                                                    $('#startTime1').val(events);
                                                    $('#calendar').fullCalendar('removeEvents');
                                                    $('#calendar').fullCalendar('addEventSource', "<?php echo base_url(); ?>index.php/scolarite/emplois_du_temps?view=1&idProgramme=" + idProgramme1 + "&semestre=" + semestre1 + "&chek1=" + str + "&local=" + local1 + "&start=" + st + "&end=" + ed + "&employe1=" + employe1 + "");
                                                    //  $('#calendar').fullCalendar({ events: "<?php echo base_url(); ?>index.php/scolarite/emplois_du_temps?view=1&idProgramme=<?php // echo $idProgramme;  ?>&semestre=<?php echo $semestre; ?>&chek1="+str+"&local=<?php // echo $local1;  ?>&start="+st+'&end='+ed+'"',    });
                                                    // $('#calendar').fullCalendar('rerenderEvents' );
                                                    // $('#calendar').fullCalendar( 'refetchEvents' );
                                                    xmlhttp.open("GET", events, true);
                                            ...
                                            function showChevauch() {
                                                ...
                                                var events = "<?php echo base_url(); ?>index.php/scolarite/chevauchement?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=" + id + "";
                                            ...
                                            function showCHSALLE(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/scolarite/chevauchement?local2=" + str + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=" + id + "";
                                            ...
                                            function showEMP(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/scolarite/chevauchement2?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + str + "&id=" + id + "";
                                            ...
                                            function showChevauchA() {
                                                ...
                                                var events = "<?php echo base_url(); ?>index.php/scolarite/chevauchement?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=0";
                                            ...
                                            function showCHSALLEA(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/scolarite/chevauchement?local2=" + str + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + prof + "&id=0";
                                            ...
                                            function showEMPA(str) {
                                                ...
                                                if (str == "") {
                                                    ...
                                                    var events = "<?php echo base_url(); ?>index.php/scolarite/chevauchement2?local2=" + local2 + "&startTimeM=" + startTimeM + "&endTimeM=" + endTimeM + "&prof=" + str + "&id=0";
